        ...
        <ScrollView>
          <View style={GlobalStyleSheet.container}>
            ...
            >
              ...
              <View style={GlobalStyleSheet.cardBody}>
                <DividerIcon
                  icon={<Feather name={"x"} color={colors.text} size={18} />}
                />
                <DividerIcon
                  color={COLORS.danger}
                  icon={
                ...
                <DividerIcon
                  ...
                  icon={
                    <Feather name={"sun"} color={COLORS.secondary} size={18} />
                  }
                />
                <DividerIcon
                  color={COLORS.info}
                  icon={
                    <Feather name={"truck"} color={COLORS.info} size={18} />
                  }
                />
                <DividerIcon
                  color={colors.title}
                  icon={
                    <Feather name={"settings"} color={colors.title} size={18} />
                  }
                />
              </View>
            </View>
